...
root = Path('/home/tk/Desktop/mycode/crazyflow/artifacts/da_plcbf/hover-explanation-20260905/renderer-review/final-shadow-review')
...
install_categories = renderer._install_marker_shadow_categories
outputs = []
try:
    ...
    for label, configure in [('before_shadow_fix', lambda *a: None), ('after_shadow_fix', configure_shadows)]:
        ...
        renderer._install_marker_shadow_categories = (lambda *a: None) if label == 'before_shadow_fix' else install_categories
